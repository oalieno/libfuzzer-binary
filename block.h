...
void get_block_info(map<unsigned long long, int> &index) {
    ...
    string whitelist[whitelist_size] = {"imp.", "_init", "entry", "deregister_tm_clones", "register_tm_clones", "__do_global_dtors_aux", "__libc_csu_init", "__libc_csu_fini", "_fini"};
